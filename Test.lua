...
local L_1 = AddToggle
local L_2 = AddButton
local L_3 = AddDropdown
local L_4 = AddSection
local L_5 = AddSlider
local L_6 = OnChanged
local L_7 = AddParagraph
local FPS_Booster = loadstring(game:HttpGet("https://raw.githubusercontent.com/jnzcn/main/main/FPS_Boost.lua"))()
--//Choose Team
...
local Window = Fluent:CreateWindow({
    Title = "Prox Hub" ..Fluent.Version,
    SubTitle = "by Tuan Nguyen",
    TabWidth = 180,
...
ImageButton.Image = "https://www.roblox.com/asset/?id=17646317550"
...
--//Tab
local Tab = ({
    Profile = Window:AddTab ({Title = "Profile", Icon = "circle-user"}),
    Setting = Window:AddTab({Title = "Setting", Icon = "gear"}),
    Main = Window:AddTab({Title = "Main Farm", Icon = "home" }),
    Misc = Window:AddTab({Title = "Misc", Icon = "layout-grid"}),
    Travel = Window:AddTab({Title = "Travel", Icon = "Island"}),
    Fruit = Window:AddTab({Title = "Fruit", Icon = "apple"}),
    SeaEvent = Window:AddTab({Title = "Sea Event", Icon = "wave"}),
    Race = Window:AddTab({Title = "Race", Icon = "meh"}),
})
--//Redeem Code
local RedeemCode = Tabs.Main:L_2({
...
--//Farm
local FarmLevel = Tabs.Main:L_1("ToggleLevel", {
    Title = "Auto Farm Level",
    Description = "Read"
    Default = false })
ToggleLevel:L_6(function(Value)
    _G.AutoLevel = Value
    if Value == false then
        wait()
...
--//Profile
local MyFacebook = Tabs.Profile:L_2({
    Title = "My Facebook",
    Description = "Copy My Facebook Link"
    Callback = function()
        setclipboard("https://www.facebook.com/tuannguyenyeue")
})
local MyDiscord = Tabs.Profile:L_7({
    Title = "My Discord Server"
    Content = "Coming Soon..."
})
local Name = Tabs.Profile:L_7({
    Title = "Name Owner"
    Content - "Tuan Nguyen"
})
--//Place Id Check
...
elseif id == 7449423635 then
    ...
    game:GetService("Players").LocalPlayer:Kick("Bro, Support Only Blox Fruit. Please Wait Update More Game.")
end
